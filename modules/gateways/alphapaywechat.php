...
function alphapaywechat_MetaData()
{
    return array(
        'DisplayName' => 'AlphaPay - Wechat',
        'APIVersion' => '1.1',
...
function alphapaywechat_config()
{
    return array(
...
function alphapaywechat_link($params) {
    ...
    $postfields = array (
        ...
        'notify_url' => $systemUrl . 'modules/gateways/callback/alphapaywechat.php',
        'operator' => 'VMISS - Wechat',
